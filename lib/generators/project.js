...
Generator.create({
  ...
  if (confirmed) {
    ...
    if (options.data.view.js.create)
      this.writeFile('client/app' + this.getConfigExtensionFor('js'), this.template('client/app.js'));
    if (options.data.view.html.create)
      this.writeFile('client/app' + this.getConfigExtensionFor('html'), this.template('client/app.html'));
